...
/**
 * Implements behavior of WallPieceState for a Blue piece
 */
public class WallPieceStateBlue extends WallPieceState {
     ...
     */
    public WallPieceStateBlue(Board theBoard, Vector leftWallPieces, Vector rightWallPieces, int piecePosition, boolean jump, Player aPlayer) {
        this.board = theBoard;
